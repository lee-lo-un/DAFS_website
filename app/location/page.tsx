    ...
    <div className="container mx-auto px-4 py-20 md:py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <h2 className="text-2xl font-semibold mb-6 text-[#3A7B89] dark:text-[#4FCADB]">
            연락처 안내
          </h2>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          ...
          <div className="mb-4 dark:text-gray-200">
            ...
            <div>
              아래 지도를 참고하시거나 전화로 문의해 주시면 상세한 안내를
              도와드리겠습니다.
            </div>
          </div>
          <p className="mb-4 dark:text-gray-200">
            <strong className="dark:text-white">대중교통:</strong> 김해시 버스
            이용
          </p>
          <p className="dark:text-gray-200">
            <strong className="dark:text-white">자가용:</strong> 내비게이션에
            '경남 김해시 생림면 안양로 46번길 23' 입력
          </p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-12">
        ...
        <div className="mt-4 flex flex-col sm:flex-row gap-4">
          ...
          >
            ...
            >
              <path
                d="M9 20L3 17V7L9 4L15 7L21 4V14L15 17L9 14V20Z"
                stroke="currentColor"
                strokeWidth="2"
                strokeLinecap="round"
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        ...
        <div className="mb-4 dark:text-gray-200">
          ...
          <div>
            방문 전 전화나 카카오톡으로 연락하시면 원활한 상담이 가능합니다.
          </div>
        </div>
        <div className="mt-6">
          <Link
